						...
						<form class="form-horizontal" action="./insertProduct" method="post">
							<fieldset>
							  <div class="control-group warning">
								...
								<div class="controls">
								  <input type="text" id="inputWarning"name="productName" placeholder="输入商品名">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">颜色</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="color" placeholder="输入颜色">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">价格</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="price" placeholder="输入价格">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">尺寸</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="size" placeholder="输入尺寸">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">图片</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="img" placeholder="输入图片">
								</div>
							  </div>
