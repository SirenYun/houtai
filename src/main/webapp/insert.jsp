			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="./insertUser" method="post">
							<fieldset>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">用户名</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="uname" placeholder="输入用户名">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">密码</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="password" placeholder="输入密码">
								</div>
							  </div>
							  <div class="control-group warning">
