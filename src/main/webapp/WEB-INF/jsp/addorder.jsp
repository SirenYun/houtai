			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Order</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="./insertOrder" method="post">
							<fieldset>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">用户Id</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="userId" value="<c:out value="${t.userId}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">用户名</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="userName" value="<c:out value="${t.userName}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">电话号码</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="tel" value="<c:out value="${t.tel}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">地址</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="address" value="<c:out value="${t.address}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">邮编</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="code" value="<c:out value="${t.code}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">邮箱</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="email" value="<c:out value="${t.email}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">总金额</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="price" placeholder="输入金额">
								</div>
								</div>
