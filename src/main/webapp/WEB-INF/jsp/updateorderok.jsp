					...
					<div class="box-content">
							...
							<fieldset>
							  ...
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">修改成功</label>
								
							  </div>
							  
							  <div class="form-actions">
								<button type="submit" class="btn btn-primary"onclick="window.location.href='queryOrder'">All Orders</button>
