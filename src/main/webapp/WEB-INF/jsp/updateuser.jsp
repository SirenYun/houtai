						...
						<form class="form-horizontal" action="./updateUser" method="post">
							<fieldset>
							  ...
							  <div class="control-group warning">
								...
								<div class="controls">
								  <input type="text" id="inputWarning"name="uname" value="<c:out value="${t.userName}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">密码</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="password" value="<c:out value="${t.password}"></c:out>">
								</div>
							  </div>
							  <div class="control-group warning">
