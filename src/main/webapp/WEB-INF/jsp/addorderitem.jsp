			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Detail</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="./insertOrderitem" method="post">
							<fieldset>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">订单Id</label>
								<div class="controls">
								  <input type="text" id="inputWarning"name="orderId" >
								</div>
							  </div>
							  <div class="control-group warning">
							  ...
							  <div class="control-group warning">
								...
								<div class="controls">
								  <input type="text" id="inputWarning"name="count" >
								</div>
							  </div>
							  <div class="control-group warning">
