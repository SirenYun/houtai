			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Delete order</h2>
						<div class="box-icon">
					...
					<div class="box-content">
							...
							<fieldset>
							  ...
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">订单内容删除成功</label>
								
							  </div>
							  
							  <div class="form-actions">
								<button type="submit" class="btn btn-primary"onclick="window.location.href='queryOrder'">All Oders</button>
