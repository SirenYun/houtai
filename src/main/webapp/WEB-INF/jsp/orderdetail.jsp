				...
				<li>
					<a href="#">Home</a> 
						    ...
						    <div class="input-prepend" title="Username">
								...
								<button type="submit" class="btn btn-primary" onclick="window.location.href='queryOrder'">Back</button>
							    </div>
							</div>
						<form action="./productorder" method="post">
						    <div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="productId" id="productId" type="text" placeholder="type productId"/>
								<div class="button-login">	
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center"><c:out value="${t.productId}"></c:out></td>
								<td class="center"><c:out value="${t.productName}"></c:out></td>
								<td class="center"><c:out value="${t.size}"></c:out></td>
								<td class="center"><c:out value="${t.count}"></c:out></td>
								<td class="center"><c:out value="${t.price}"></c:out></td>
								<td class="center">
									
									<a class="btn btn-info" href="./findupdate?orderitemId=${t.orderitemId}">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="./deleteOrderitem?orderitemId=${t.orderitemId}">
