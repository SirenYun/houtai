		...
		<div class="row-fluid">
           ...
           <form action="./searchProduct" method="post">
						    <div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="productName" id="username" type="text" placeholder="type productname"/>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center"height=100 width=75><img src="${t.img}"/></td>
								<td class="center"width=400><c:out value="${t.productName}"></c:out></td>
								<td class="center"><c:out value="${t.color}"></c:out></td>
								<td class="center"><c:out value="${t.price}"></c:out></td>
								<td class="center"><c:out value="${t.size}"></c:out></td>
								
								<td class="center">
									
									<a class="btn btn-info" href="./selectProductById?productId=${t.productId}">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="./deleteProduct?productId=${t.productId}">
